...
private[deploy] class SparkSubmitArguments(args: Seq[String], env: Map[String, String] = sys.env)
  ...
  var master: String = null // 主节点
  var deployMode: String = null // 部署模式
  var executorMemory: String = null // executor内存
  var executorCores: String = null // executor核心数
  var totalExecutorCores: String = null // executor总核心数
  var propertiesFile: String = null // properties配置文件
  var driverMemory: String = null // driver内存
  var driverExtraClassPath: String = null
  var driverExtraLibraryPath: String = null
  var driverExtraJavaOptions: String = null
  var queue: String = null
  var numExecutors: String = null // executor个数
  ...
  val sparkProperties: HashMap[String, String] = new HashMap[String, String]() // 运行状态中spark配置参数
  ...
  var useRest: Boolean = true // used internally spark内部使用,主要根据spark版本内部定义使用哪种类型的主函数

  /** Default properties present in the currently defined defaults file. */
  /**
    * 默认的配置参数(spark-defaults.conf文件)
    */
